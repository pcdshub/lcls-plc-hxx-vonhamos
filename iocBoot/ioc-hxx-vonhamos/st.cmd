...
epicsEnvSet("LOCATION", "PLC:HXX:VONHAMOS" )
...
epicsEnvSet("IPADDR",           "172.21.88.187")
epicsEnvSet("AMSID",            "172.21.88.187.1.1")
...
epicsEnvSet("PREFIX",         "PLC:HXX:VONHAMOS:")
...
epicsEnvSet("MOTOR_PREFIX",    "HXX:VON_HAMOS:MMS:")
epicsEnvSet("MOTOR_NAME",      "01")
epicsEnvSet("DESC",            "Main.M1 / VonHamosY")
epicsEnvSet("EGU",             "mm")
epicsEnvSet("PREC",            "3")
...
dbLoadRecords("iocSoft.db", "IOC=PLC:HXX:VONHAMOS")
dbLoadRecords("save_restoreStatus.db", "P=PLC:HXX:VONHAMOS:")
dbLoadRecords("caPutLog.db", "IOC=${IOC}")

## TwinCat System Databse files ##
dbLoadRecords("TwinCAT_TaskInfo.db", "PORT=ASYN_PLC, PREFIX=PLC:HXX:VONHAMOS")
dbLoadRecords("TwinCAT_AppInfo.db", "PORT=ASYN_PLC, PREFIX=PLC:HXX:VONHAMOS")
...
save_restoreSet_status_prefix( "PLC:HXX:VONHAMOS:" )
